...
<body>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="showContacts.jsp"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
                                        <li>
    ...
    <td align="center">
 		<form:form action="saveContactempdata.do" method="post" commandName="newEmployeeData">
				...
				<table width="500" style="border-collapse: collapse;" border="0" bordercolor="#006699" cellspacing="2" cellpadding="2">	
					...
					<tr>
						<td width="100" align="right">sal</td>
						<td><form:input path="sal" disabled="true"/></td>
					</tr>
					<tr>
						<td width="100" align="right">salPerDay</td>
						<td><form:input path="salPerDay" value="200" disabled="true"/></td>
					</tr>
					<tr>
						<td width="100" align="right">days</td>
						<td><form:input path="days" disabled="true"/></td>
						</tr>
					<tr>
						<td width="100" align="right">totalSalary</td>
						<td><form:input path="totalSalary" disabled="true"/></td>
						</tr>
					<tr>
						<td width="100" align="right">monttName</td>
						<td><form:input path="monttName"/></td>
						</tr>
					<tr>
						...
						&nbsp;&nbsp;
						<input type="button"  value="Back" onclick="javascript:go('viewAllEmpContacts.do');">
						</td>
					</tr>					 
				</table>			
		</form:form>
