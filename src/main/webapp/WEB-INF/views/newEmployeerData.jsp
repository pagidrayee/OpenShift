...
<body>
    ...
    <td align="center">
 		<form:form action="saveContactemprdata.do" method="post" commandName="newEmployeerData">
				...
				<table width="500" style="border-collapse: collapse;" border="0" bordercolor="#006699" cellspacing="2" cellpadding="2">	
					...
					<tr>
						<td width="100" align="right">Father name</td>
						<td width="150">
						<form:input path="fname"/></td>
					</tr>
				
					 <tr>
						<td width="100" align="right">Date of joining</td>
					...
					<tr>
						<td width="100" align="right">qualification</td>
						<td><form:input path="qualification"/></td>
						</tr>
					<tr>
						<td width="100" align="right">exp</td>
					...
					<tr>
						...
						&nbsp;&nbsp;
						<input type="button"  value="Back" onclick="javascript:go('viewAllEmprContacts.do');">
						</td>
					</tr>					 
				</table>			
		</form:form>
