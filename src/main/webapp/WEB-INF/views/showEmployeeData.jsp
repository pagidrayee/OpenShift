		...
		<div class="row">
				<div class="col-lg-12">
					<form:form action="searchContacts.do" method="post">
						...
						<font color="Green" size="5%">Save Employee Contact Details</font>
                         &nbsp;&nbsp;
						<input type="button" value="Employee Details"
							onclick="javascript:go('saveContactempdata.do');" />
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>								
								<c:forEach var="empdata" items="${SEARCH_EMP_CONTACTS_RESULTS_KEY}">
										<tr>
											<td class="odd gradeX"><c:out value="${empdata.id}"></c:out></td>
											<td class="odd gradeX"><c:out value="${empdata.name}"></c:out></td>
											<td class="odd gradeX"><c:out value="${empdata.createdDate}"></c:out>
											</td>
											<td class="odd gradeX"><c:out value="${empdata.sal}"></c:out>
											</td>
											<td class="odd gradeX"><c:out value="${empdata.salPerDay}"></c:out></td>
											<td class="odd gradeX"><c:out value="${empdata.days}"></c:out></td>
											<td class="odd gradeX"><c:out value="${empdata.totalSalary}"></c:out></td>
											<td class="odd gradeX"><c:out value="${empdata.monttName}"></c:out></td>
