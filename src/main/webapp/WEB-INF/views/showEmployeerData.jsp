		...
		<div class="row">
				<div class="col-lg-12">
					<form:form action="searchContacts.do" method="post">
						...
						<font color="Green" size="5%">Save Employeer Contact Details</font>
                         &nbsp;&nbsp;
						<input type="button" value="Employee Details"
							onclick="javascript:go('saveContactemprdata.do');" />
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>								
								<c:forEach var="emprdata" items="${SEARCH_EMPR_CONTACTS_RESULTS_KEY}">
										<tr>
											<td class="odd gradeX"><c:out value="${emprdata.id}"></c:out></td>
											<td class="odd gradeX"><c:out value="${emprdata.name}"></c:out></td>
											<td class="odd gradeX"><c:out value="${emprdata.fname}"></c:out></td>											
											<td class="odd gradeX"><c:out value="${emprdata.doj}"></c:out>
											</td>
											<td class="odd gradeX"><c:out value="${emprdata.gender}"></c:out>											
											<td class="odd gradeX"><c:out value="${emprdata.sal}"></c:out>
											</td>
											<td class="odd gradeX"><c:out value="${emprdata.address}"></c:out></td>
											<td class="odd gradeX"><c:out value="${emprdata.qualification}"></c:out></td>
											<td class="odd gradeX"><c:out value="${emprdata.exp}"></c:out></td>
											<td bgcolor="white">
											<a
												href="updateContact.do?id=${empdata.id}">Edit</a></td>
											<td bgcolor="white"><input type="button" value="Delete"
												onclick="javascript:deleteContact('deleteContact.do?id=${empdata.id}');">
											</td>
										</tr>
								</c:forEach>
								</tbody>
